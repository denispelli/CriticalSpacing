...
%****************
%% CUSTOM CODE for Louisa
% RUN 

% o.useFractionOfScreen=0.3; 
o(1).foldername=strcat('data/Louisa',date);

o.practicePresentations=0;
o.experimenter='Louisa';
o.observer='';

o.viewingDistanceCm=300;
%o.eccentricityXYDeg=[0.1 0.1]; % Distance of target from fixation. Positive up and to right.
...
o.targetDeg=nan;
o.useFixation=0;
o.trials=10; % Number of trials (i.e. responses) for the threshold estimate.

o.run_n = 1;  %%%  Added this to start first run
...
o.fixedSpacingOverSize=1.4; % Requests size proportional to spacing, horizontally and vertically.
o.radialOrTangential='horizonatal'; % vertically arranged flankers for single target
%o.radialOrTangential='radial'; % horizontally arranged flankers for single target

% o(2)=o(1); % Copy the condition
oSingle=CriticalSpacingLouisa(o); 

o(1).run_n = 2;

o(1).observer=oSingle(1).observer;
o(2).observer=oSingle(1).observer;

o(2) = o(1); %

o(1).repeatedTargets=0;
o(2).repeatedTargets=1;

o(1).thresholdParameter='size';%Confirm it is not size
o(2).thresholdParameter='spacing';%Confirm it is not spacing

o(1).fixedSpacingOverSize=1.4;
o(2).fixedSpacingOverSize=1.4;

oRepeated=CriticalSpacingLouisa(o); 

o(1).run_n = 3;
o(2)=[];%Measuring only one threshold
...
o.repeatedTargets=0;
o.fourFlankers=0;
o.fixedSpacingOverSize=0.1;

o=CriticalSpacing(o); 

Speak('Congratulations. Great job!');
