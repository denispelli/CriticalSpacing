...
o.trialsDesired=50; % Number of trials (i.e. responses) for the threshold estimate.

% o.observer='putNameHere';
for ecc=[4  4  4]
   o=o(1);
   if ecc<1
      o.fixationCrossBlankedNearTarget=1;
   ...
   o.textSizeDeg=0.4;
   o.alphabet='DHKNORSVZb';
   o.flankerLetter='b'; % use bar flanker
   o=CriticalSpacing(o);
   o.alphabet='DHKNORSVZ';
   o.flankerLetter=''; % user random letter flanker
   o=CriticalSpacing(o);
end
