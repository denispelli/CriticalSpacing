...
%
% Take a 2-D line from xy1 to xy2, and clip to rectangle r with corners at
% v1, v2. If nothing remains the output arguments are NaN.
%
...
if 0
   ...
   ClippedLine([-1,-1],[3,2],[0 0 1 1]);
   ClippedLine([0.5,0.3],[1.3,0.7],[0 0 1 1]);
   ClippedLine([-0.5,1.2],[1.3,0.7],[0 0 1 1]);
   ClippedLine([-0.5,0.7],[0.3,0.7],[0 0 1 1]);
   ClippedLine([0.2,1.3],[0.1,-0.4],[0 0 1 1]);
   
   [newXY1,newXY2] =ClippedLine([0,-.04],[0,-0.04],[0 0 1 1]);
   ClippedLine([0.2,.5],[0.8,.5],[0 0 1 1]);
end
end
