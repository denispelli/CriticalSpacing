...
% Currently this code insists that no window be open. That turns out to be
% an annoying restriction. It would be better to allow windows to be open,
% and to use a try-catch block to intercept any error. If we need to flag
% an error then we could close the windows before throwing the error. This
...
if ~isempty(Screen('Windows'))
    error(['AutoBrightness called while onscreen windows are open. ' ...
