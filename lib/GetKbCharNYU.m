function [ch, when] = GetKbCharNYU(varargin)
% [ch, when] = GetKbCharNYU([deviceIndex][, untilTime=inf][, optional KbCheck arguments...]);
% NYU version enhanced to also accept the Escape key, which is returned as
% an ordinary character with ascii code 27. denis.pelli@nyu.edu February
% 14, 2016.
%
