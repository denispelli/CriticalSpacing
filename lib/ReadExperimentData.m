...
%         'isFixationBlankedNearTarget' 'fixationMarkDeg' ...
%         'fixationIsOffscreen'  ...
%         'fixationThicknessDeg' 'fixationOnScreen' 'fixationXYPix'  ...
...
vars=[vars 'responseCount']; % We need this later, so make sure it's included.
oo=struct([]);
